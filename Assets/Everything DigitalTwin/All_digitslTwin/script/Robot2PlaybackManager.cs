...
public class Robot2PlaybackManager : MonoBehaviour
{
    public static Robot2PlaybackManager Instance; // Singleton instance

    public double[] CurrentJointAngles2 = new double[6]; // Current joint angles for Robot 2
    ...
    public string logFilePath = @"C:\Users\cbbair01\Downloads\Robot2MovementData.csv"; // Path to the log file
    ...
    private void Awake()
    {
        Debug.Log("Robot2PlaybackManager Awake called.");
        if (Instance == null)
        {
            Instance = this;
        }
    ...
    void FixedUpdate()
    {
        ...
        if (currentFrame == 5163 && !hasCompleted)
        {
            if (!hasCompleted)
            {
                hasCompleted = true;
        ...
        CurrentJointAngles2 = JointData[currentFrame];
    ...
    private void LoadLogData(string filePath)
    {
        try
        {
            using (var reader = new StreamReader(filePath))
            {
                ...
                // Find the indices for timestamp and actual_q_0 to actual_q_5
                ...
                string line;
                double scalingFactor = 2.0; // Scale timestamps by this factor
            ...
            Debug.Log("Log data loaded successfully.");
        }
        catch (Exception ex)
        {
    ...
    {
        Debug.Log("Part two has been placed!");
        ...
        if (completionPopup != null)
        {
            ...
            if (popupText != null)
            {
                popupText.text = "Congrats! Part two has been placed! Please proceed to the Yellow Printer to print";
            }

            // Disable the popup after 3 seconds
